...
class KickRejoin(BaseExtension):
    ...
    def __init__(self, base, **kwargs):
        ...
        rejoin_delay
            Seconds until the channel is rejoined.  This defaults to 5, but can be
            set to anything.  Some people may think you're rude if you set it to 0.
        rejoin_on_remove
            Boolean defining whether to rejoin if you are 'removed'.  Note that most
            servers propogate REMOVE as KICK to clients so it won't always work (the
            sole exception in testing this extension was Freenode).  Defaults to
            True, because REMOVE is silly anyway.
        """
